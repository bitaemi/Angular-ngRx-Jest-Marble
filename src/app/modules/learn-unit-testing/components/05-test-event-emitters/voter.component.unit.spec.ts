...
describe('Unit Testing VoterComponent', () => {
    ...
    describe('When I upvote,', () => {
      ...
      it('should raise myVoteChanged event when upvoted', () => {
        // beause event emitter is an observabale we can subscribe to get the event raised
        // INITIALIZATION
        let totalVotes = null;
        component.myVoteChanged.subscribe(tv => totalVotes = tv);
        // ACT
        component.upVote();
